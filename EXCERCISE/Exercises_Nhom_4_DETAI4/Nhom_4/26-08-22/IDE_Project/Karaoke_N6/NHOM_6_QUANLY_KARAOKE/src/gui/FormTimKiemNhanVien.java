...
public class FormTimKiemNhanVien extends JFrame {
	...
	public FormTimKiemNhanVien() {
		...
		lblNewLabel.setBounds(64, 87, 97, 26);
		panel_2.add(lblNewLabel);

		txtMaCV = new JTextField();
		txtMaCV.setBounds(195, 83, 171, 42);
		panel_2.add(txtMaCV);
		...
		btnTailai.setBounds(1114, 389, 208, 64);
		btnTailai.setFont(new Font("Tahoma", Font.BOLD, 13));
		btnTailai.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/tailai.png")));
		btnTailai.setText("Tải lại");
		btnTailai.setBackground(new Color(255, 246, 143));
		...
		btnTimKiem.setBounds(598, 389, 208, 64);
		btnTimKiem.setFont(new Font("Tahoma", Font.BOLD, 13));
		btnTimKiem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/timkiem(1).png")));
		...
		JLabel lblNewLabel_8 = new JLabel("TÌM KIẾM NHÂN VIÊN");
		...
		btnRf.setBounds(1484, 14, 228, 53);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(FormTimKiemNhanVien.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
