...
public class Gui_CuaSoUpDateNV extends JFrame implements ActionListener, WindowFocusListener, WindowListener {
	...
	public Gui_CuaSoUpDateNV(String maNV) {
		...
		comboBoxTT.setModel(new DefaultComboBoxModel<String>(new String[] { "�?ang làm việc", "�?ã nghỉ việc" }));
		...
		for (NhanVien nhanVien : nv) {
			...
			if (tt.equals("0")) {
				comboBoxTT.setSelectedItem("�?ã nghỉ việc");
			} else {
				comboBoxTT.setSelectedItem("�?ang làm việc");
			}
		}
