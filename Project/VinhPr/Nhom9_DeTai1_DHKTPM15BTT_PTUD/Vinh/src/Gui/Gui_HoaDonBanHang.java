...
public class Gui_HoaDonBanHang extends JFrame implements ActionListener, MouseListener, KeyListener {
	...
	public Gui_HoaDonBanHang() {
		...
		JLabel lblNewLabel_2 = new JLabel("HÓA �?ƠN B�?N HÀNG");
		...
		String[] cols = { "Mã sản phẩm", "Tên sản phẩm", "Màu", "Size", "Hang", "Số lượng tồn", "Lô hàng", "�?ơn giá" };
		...
		btnXoaSP = new JButton("Xóa kh�?i hóa đơn");
		...
		JLabel lblNewLabel_4_3_2 = new JLabel("�?ịa chỉ:");
		...
		JLabel lblNewLabel_5_2 = new JLabel("Tổng thành ti�?n (VND) :");
		...
		JLabel lblNewLabel_5_2_1 = new JLabel("Ti�?n khách đưa (VND):");
		...
		JLabel lblNewLabel_5_2_1_1 = new JLabel("  Ti�?n thối lại (VND):");
		...
		// Lấy mã nhân viên đang dùng phần m�?m
		getNV();
...
//Hàm lấy giới tính kh
	...
	public void actionPerformed(ActionEvent e) {
		...
		// event xóa sản phẩm ra kh�?i danh sách sản phẩm
	...
	public void xoaSP() {
		...
		if (row >= 0) {
			...
			JOptionPane.showMessageDialog(this, "Ch�?n dòng cần xoá!");
		}
	}
	...
	public void addSP() {
		...
		if (row >= 0) {
			...
			JOptionPane.showMessageDialog(this, "Ch�?n sản phẩm cần bán!");
		}
	...
	// Tính ti�?n thối lại cho khách hàng
	public void getTT() {
	...
	public void xuatfile() {
		try {
			...
			cell.setCellValue("Cửa hàng th�?i trang VTTM");
			...
			cell = row.createCell(12, CellType.STRING);
			cell.setCellValue("�?ịa Chỉ: " + textDC.getText());

			row = sheet.createRow((short) 9);
			row.setHeight((short) 500);
			cell = row.createCell(10, CellType.STRING);
			cell.setCellValue("Hóa �?ơn Bán Hàng");
			...
			cell = row.createCell(13, CellType.STRING);
			cell.setCellValue("Ti�?n khách đưa: " + textTienKhachDua.getText() + "VND");

			row = sheet.createRow((short) 11 + n + 2);
			row.setHeight((short) 500);
			cell = row.createCell(8, CellType.STRING);
			cell.setCellValue("Tổng ti�?n: " + texTongThanhTien.getText() + "VND");
			cell = row.createCell(13, CellType.STRING);
			cell.setCellValue("Ti�?n thối lại: " + textTienThoi.getText() + "VND");
