...
public class Gui_TKeTheoThang extends JFrame implements ActionListener {
	...
	public Gui_TKeTheoThang() {
		...
		String[] cols = { "STT", "Mã sản phẩm", "Tên sản phẩm", "Màu", "Size", "Loại", "Số lượng", "Lô hàng",
				"Mã nhà cung cấp", "Tên nhà cung cấp", "Giá nhập", "Giá Bán", "Thành Ti�?n" };
		...
		JLabel lblDanhSchSn = new JLabel("Danh Sách Sản Phẩm �?ã Bán");
		...
		JLabel lblDanhSchSn_2 = new JLabel("Danh Sách Sản Phẩm �?ã Nhập");
