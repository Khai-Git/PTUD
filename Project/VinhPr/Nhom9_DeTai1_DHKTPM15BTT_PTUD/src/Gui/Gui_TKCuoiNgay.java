...
public class Gui_TKCuoiNgay extends JFrame implements ActionListener {
	...
	public Gui_TKCuoiNgay() {
		...
		new JPanel();
		String[] cols = { "STT", "Mã sản phẩm", "Tên sản phẩm", "Màu", "Loại", "Size", "Lô hàng", "Số lượng", "Đơn giá",
				"Thành Tiền" };
		...
		JLabel lblNewLabel_1 = new JLabel("Danh Sách Sản Phẩm Đã Bán");
		...
		JLabel lblTngSChit = new JLabel("Sản phẩm bán nhiều nhất :");
	...
	// Lấy thông tin sp bán nhiều nhất
	public void getSPLN() {
		int a = 0;
		int b = 0;
		int c = 0;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btnXN)) {
			xuatfile();
			JOptionPane.showMessageDialog(this, "Đã in báo cáo!!");
		}
