...
public class Gui_TKeTheoNam extends JFrame implements ActionListener {
	...
	public Gui_TKeTheoNam() {
		...
		JLabel lblNewLabel = new JLabel("Thống kê cuối năm");
		...
		JLabel lblNewLabel_1_2 = new JLabel("Tổng tiền đã thu:");
		lblNewLabel_1_2.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1_2.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_1_2.setBounds(724, 742, 155, 38);
		contentPane.add(lblNewLabel_1_2);

		JLabel lblNewLabel_1_2_1 = new JLabel("Tổng tiền lãi:");
	...
	public void xuatfile() {
		try {
			...
			int b = a.getYear();
			cell.setCellValue("Thống kê cuối năm " + String.valueOf(b));
